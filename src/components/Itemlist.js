...
import { sdk, FetchTypeExport, gameId } from "../services";
import Card from "./CardNFT";
import History from "./HistoryTransaction";

export const Itemlist = () => {
  const { transactions, items, getAllItems, transferNFT } = useContext(
    GlobalContext
  );
  ...
  return (
    <div className="lg:p-10 md:p-10 sm:p-10 p-5">
      ...
      <h2 className="font-medium leading-tight text-2xl mt-10 mb-2 text-black-600">
